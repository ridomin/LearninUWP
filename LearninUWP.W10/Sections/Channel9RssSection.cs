...
{
    public class Channel9RssSection : Section<RssSchema>
    {
		private RssDataProvider _dataProvider;

		public Channel9RssSection()
		{
		...
		public override async Task<IEnumerable<RssSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                Url = new Uri("https://s.ch9.ms/Events/Build/2015/RSS"),
            };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    Page = typeof(Pages.Channel9RssListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.Channel9RssDetailPage>(true);
                    }
                };
            }
        }
