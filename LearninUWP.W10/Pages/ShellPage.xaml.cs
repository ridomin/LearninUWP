...
namespace LearninUWP.Pages
{
    public sealed partial class ShellPage : Page
    {
        ...
        private void InitializeNavigationItems()
        {
            ...
            NavigationItems.Add(AppNavigation.NodeFromAction(
				"6836d488-279f-4210-af53-2547d0fb790a",
                "Sessions",                
                AppNavigation.ActionFromPage("SessionsListPage"),
				AppNavigation.IconFromGlyph("\ue15d")));

            NavigationItems.Add(AppNavigation.NodeFromAction(
				"64274a5d-de9a-4cf0-812f-8cae50fb9edc",
                "Speakers",                
                AppNavigation.ActionFromPage("SpeakersListPage"),
				AppNavigation.IconFromGlyph("\ue125")));

            NavigationItems.Add(AppNavigation.NodeFromAction(
				"fc2541d8-69bb-4591-8e6b-e95c22be38b3",
                "Gallery",                
                AppNavigation.ActionFromPage("GalleryListPage"),
				AppNavigation.IconFromGlyph("\ue114")));

            NavigationItems.Add(AppNavigation.NodeFromAction(
				"cb162b3e-1a87-4ce5-9e38-3fe879213d84",
                "Channel 9 Rss",                
                AppNavigation.ActionFromPage("Channel9RssListPage"),
				AppNavigation.IconFromGlyph("\ue12a")));

            NavigationItems.Add(AppNavigation.NodeFromAction(
				"0e327bf2-168a-4355-a53e-49c994b83363",
                "Press Release",                
                AppNavigation.ActionFromPage("PressReleaseListPage"),
				AppNavigation.IconFromGlyph("\ue185")));
